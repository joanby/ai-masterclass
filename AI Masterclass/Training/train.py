...
# Making a function that receives packets from slaves after the slaves are done with the simulation process and gathered all the information (e.g. the average reward)
...
# Making a function that evaluates a batch of states/frames with the provided model parameters and returns the average reward
